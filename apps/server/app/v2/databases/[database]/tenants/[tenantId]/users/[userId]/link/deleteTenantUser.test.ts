...
describe("mark a user deleted", () => {
  it("404s if the user is not in the tenant", async () => {
    ...
    expect(runCommands).toEqual([
      ...
      ":SET LOCAL nile.tenant_id = 'whatever'; :SET LOCAL nile.user_id = '019073f4-75a6-72b9-a379-5ed38ca0d01a'; DELETE FROM users.tenant_users WHERE user_id = 019073f4-75a6-72b9-a379-5ed38ca0d01a",
    ]);
  });
