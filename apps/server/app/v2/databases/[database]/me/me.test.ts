...
describe("me", () => {
  ...
  it("returns the session user", async () => {
    ...
    expect(runCommands).toEqual([
      'SELECT id, email, name, family_name AS "familyName", given_name AS "givenName", picture, created, updated FROM users.users WHERE id = some-uuid AND deleted IS NULL',
